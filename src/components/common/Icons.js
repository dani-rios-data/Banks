...
// Colección de iconos SVG para usar en toda la aplicación
const Icons = {
  summary: (
  ...
  chartLine: (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M3 3a1 1 0 000 2h14a1 1 0 000-2H3zm0 6a1 1 0 000 2h9a1 1 0 000-2H3zm0 6a1 1 0 100 2h5a1 1 0 000-2H3z" clipRule="evenodd" />
    </svg>
  ),
